...
const PREV_MSGS = [
  ...
  { color:'#D399FF', user:'classybeef_fan',    msg:'Hello! This is your chat overlay \u{1F44B}', dot:null,     dots:0 },
    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ── Header — logo centered like chatis ── */
        header {
          display: flex;
        ...
        .header-logo {
          width: 96px;
          height: 96px;
          animation: ckSpin 3s linear infinite;
        }
        @keyframes ckSpin {
        ...
        /* ── Feature list ── */
        #feature-list { color: #909090; font-size: 0.88rem; line-height: 1.9; padding-left: 1.2rem; margin-bottom: 20px; }
        #feature-list li::marker { color: #53fc18; }

        /* ── Commands ── */
        .commands-section { margin-bottom: 24px; }
        .section-title { font-size: 0.85rem; color: #53fc18; font-weight: 700; margin: 0 0 8px; text-transform: uppercase; letter-spacing: .08em; }
        .cmd-table { width: 100%; border-collapse: collapse; font-size: 0.8rem; }
        ...
        .cmd-table td:first-child { color: #53fc18; font-family: 'Roboto Mono', monospace; white-space: nowrap; font-size: 0.75rem; }
        .cmd-table tr:last-child td { border-bottom: none; }
        .cmd-access { font-size: 0.72rem; color: #666; }
        ...
        .form_col { flex: 1; }
        .form_col:first-child { border-right: 1px solid #333; padding-right: 24px; }
        ...
        input[type=text], input[type=number], select {
          ...
          border-radius: 5px; color: #d8d8d8;
          padding: 5px 10px; font-size: 0.87rem;
        ...
        input[type=checkbox] { width: 16px; height: 16px; cursor: pointer; accent-color: #53fc18; }

        /* Toggle switch — like chatis */
        .toggle-wrap { display: flex; align-items: center; gap: 8px; justify-content: flex-end; margin-bottom: 11px; }
        .toggle-wrap label { font-size: 0.87rem; color: #a0a0a0; cursor: pointer; user-select: none; order: -1; }
        ...
        #example {
          ...
          background: repeating-conic-gradient(#1e1e1e 0% 25%, #171717 0% 50%) 0 0 / 16px 16px;
        ...
        input[type=submit] {
          ...
          border-radius: 7px; font-size: 1rem; font-weight: 800;
          padding: 12px 32px; cursor: pointer; font-family: inherit;
        ...
        #result p { color: #666; font-size: 0.8rem; margin: 6px 0 0; }
        ...
        /* ── Footer ── */
        footer { border-top: 1px solid #2a2a2a; padding: 20px 0; text-align: center; font-size: 0.8rem; color: #555; margin-top: 20px; }
      ...
      <div className="page">
        ...
        {/* ── Header — Kick GIF spinning like chatis Peepo ── */}
        <header>
        ...
        {/* ── Feature list ── */}
        <p style={{ marginBottom:'0.2rem', fontSize:'0.85rem', color:'#666', textTransform:'uppercase', letterSpacing:'.07em', fontWeight:700 }}>Features</p>
        <ul id="feature-list">
        ...
        <form name="generator" onSubmit={e => { e.preventDefault(); copy(); }}>
          ...
          <div className="form_table">
            ...
            <div className="form_col">
              ...
              <div className="form_row left">
                <select name="font" value={font} onChange={e => setFont(e.target.value)} style={{ fontFamily: fontCSS }}>
              ...
              <div className="form_row left">
                <input type="text" name="emoteScale" placeholder="1.0" style={{ width: 80 }}
            ...
            <div className="form_col">
                ...
                <label style={{ display:'flex', alignItems:'center', gap:6 }}>
                  ...
                  {fadeBool && (
                    <span style={{ display:'inline-flex', alignItems:'center', gap:4 }}>
                      <input type="text" name="fade" value={fade} className="short"
                        onChange={e => setFade(e.target.value)} style={{ width:46 }} />
                      <span style={{ fontSize:'0.78rem', color:'#666' }}>sec</span>
                    </span>
                  )}
                </label>
                <label className="toggle">
                ...
                <div className="toggle-wrap" style={{ gap:10 }}>
                  ...
                  {(['min','max'] as const).map(v => (
                    <label key={v} style={{ display:'flex', alignItems:'center', gap:4, cursor:'pointer' }}>
                      ...
                      <span style={{ fontSize:'0.78rem', color: textBgWidth===v ? '#53fc18' : '#666' }}>
                        {v === 'min' ? 'Fit' : 'Full'}
                      </span>
                    </label>
                  ))}
              ...
              <div style={{ borderTop:'1px solid #2a2a2a', marginTop:8, paddingTop:10 }}>
                <p style={{ margin:'0 0 6px', fontSize:'0.78rem', color:'#666', textAlign:'right' }}>Extra bots to hide (comma-separated)</p>
          ...
          <div id="submit_container">
            <div id="example">
              <div className="example-inner" style={{
                ...
                <style>{`
                  .preview-badge {
                    width: ${psz.bw} !important; height: ${psz.bh} !important;
                    min-width: ${psz.bw}; min-height: ${psz.bh};
                    max-width: ${psz.bw}; max-height: ${psz.bh};
                    vertical-align: middle; border-radius: 10%; display: inline-block;
                    margin-right: ${psz.bmr}; margin-bottom: ${psz.bmb};
                  }
                    ...
                    {!hideNames && (
                      <span style={{ display:'inline-block' }}>
                        {m.dot && Array.from({ length: m.dots }).map((_, bi) => (
                          <span key={bi} className="preview-badge" style={{ background: m.dot!, opacity:0.9 }} />
                        ))}
                        <span style={{ color: m.color, fontWeight:800 }}>{m.user}</span>
                        {!nlAfterName ? <span className="preview-colon">:</span> : <br />}
                      </span>
                    )}{' '}
                    <span>{m.msg}</span>
                  </div>
        ...
        <div id="result">
          ...
          <p>Paste this URL into OBS as a Browser Source. Recommended size: <strong>830 × 230</strong>.</p>
        </div>
